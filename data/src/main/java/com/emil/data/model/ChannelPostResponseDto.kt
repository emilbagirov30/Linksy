...
class ChannelPostResponseDto (val postId: Long=0, val channelName: String="", val channelAvatarUrl: String="", val text: String?=null, val imageUrl: String? = null,
                              val videoUrl: String?=null, val audioUrl: String?=null, val publishDate: String="", val pollTitle: String?=null, val isVoted:Boolean,val options: List<OptionResponseDto> = emptyList(),
