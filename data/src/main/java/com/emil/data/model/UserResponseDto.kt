...
class UserResponseDto (val id:Long = 0,val avatarUrl:String="",val username:String="",val link:String?=null,val online:Boolean = false,val confirmed:Boolean=false)
