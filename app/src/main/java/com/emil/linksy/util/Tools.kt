...
class Linksy {
    companion object {
        ...
        const val SHAREDPREF_THEME_KEY = "theme"
        const val SHAREDPREF_THEME_VALUE_LIGHT = "light"
        const val SHAREDPREF_THEME_VALUE_DARK = "dark"
        const val SHAREDPREF_REMEMBER_KEY = "remember"
        const val SHAREDPREF_LANGUAGE_KEY = "language"
        const val SHAREDPREF_LANGUAGE_VALUE_RU = "ru"
        const val SHAREDPREF_LANGUAGE_VALUE_EN = "en"
        const val INTENT_ACTION_NEW_CHAT = "NEW_CHAT_RECEIVED"
        const val EMPTY_AVATAR = "null"
        const val INTENT_USER_ID_KEY = "USER_ID"
        const val INTENT_CHANNEL_ID_KEY = "CHANNEL_ID"
        const val INTENT_GROUP_ID_KEY = "GROUP_ID"
        const val INTENT_TARGET_KEY = "TARGET"
        const val INTENT_TARGET_VALUE_USER = "USER"
        const val INTENT_TARGET_VALUE_CHANNEL = "CHANNEL"
